...
var door1, door2;
var prisonGuard1, prisonGuard2, LprisonGuardImg, RprisonGuardImg;
...
function setup() {
	...
	inviWall2 = createSprite(500,20,1000,40);
	inviWall2.visible = false;
	inviWall3 = createSprite(55,220,150,100);
...
function draw() {
	...
	if(task === 4){
		...
		if(prisonGuard1.visible === false){
			text("You takenDown the guard no. 1",330,40);
		}
		//if(prisonGuard1.visible === false){
		//	text("you takenDown the guard no. 1",330,40);
		//}
